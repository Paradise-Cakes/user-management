...
def test_handler_forgot_password_message():
    ...
    assert result["response"]["emailMessage"] == (
        "<p>Hello Anthony,</p><p>Click the link below to reset your password:</p><p><a href='https://megsparadisecakes.com/?reset=true?username=anthony.soprano%40gmail.com&code=123456'>Reset Password</a></p><p>If you did not request this password reset, please ignore this email.</p>"
    )
